...
>>>>>>> cba1f9c17a342638cc9ef1d352c0f6c825088f44
            ...
            <div class="card-body">
              <h5 class="card-title">
                <i
                  ...
                  style="font-size: 2.5vw; color: #fe0000"></i>
              </h5>
      ...
      <div class="row justify-content-md-center gap-5">
        <div class="col-5 text-start">
          ...
          <div class="d-flex gap-3">
            <a href="" style="font-size: 3vw; color: #000"><i class="fa-brands fa-x-twitter"></i></a>
            <a
              href="https://www.instagram.com/begusaurus?igsh=MWRucmN5ZjJuaTMwcQ=="
              style="font-size: 3vw; color: #000"><i class="fa-brands fa-instagram"></i></a>
            <a
              href="https://wa.me/6282188664614"
              style="font-size: 3vw; color: #000"><i class="fa-brands fa-whatsapp"></i></a>
          </div>
        </div>
        <div class="col-5">
            ...
            <div class="row">
              <div class="col mb-4">
                <i
                  ...
                  style="color: #000; font-size: 8vw"></i>
              </div>
            </div>
            <div class="row">
